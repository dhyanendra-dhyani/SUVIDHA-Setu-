            ...
            <div className="min-h-screen flex flex-col items-center justify-start px-4 py-6 max-w-2xl mx-auto">
                ...
                <div className="w-full mb-3">
                    <button
                        ...
                        className={`w-full py-3 rounded-xl border flex items-center justify-center gap-3 cursor-pointer transition-colors ${isListening
                    ...
                    >
                        ...
                        <div className="text-left">
                            <p className="font-bold text-sm">{isListening ? 'Listening...' : 'Just Speak / बोलिए'}</p>
                            <p className="text-xs opacity-60">{isListening ? 'Say something in your language' : 'Auto-detect language'}</p>
                        </div>
                    </button>
                    {voiceHint && (
