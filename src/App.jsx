/**
 * ═══════════════════════════════════════════════════════════
 * SUVIDHA Setu — Main App v3.0 (Zero Framer-Motion)
 *
 * ALL animations are pure CSS. No JavaScript animation loops.
 * React.lazy code splitting. Minimal re-renders.
 * ═══════════════════════════════════════════════════════════
 */
        ...
        {showPersistent && (
          <>
            ...
            <footer className="border-t border-white/5 py-2 text-center no-print">
              <p className="text-white/20 text-xs">C-DAC SUVIDHA 2026 • {t(lang, 'poweredBy')} • v3.0</p>
            </footer>
          </>
        )}
      </Suspense>
